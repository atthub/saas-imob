/**
 * GET /api/feed/zap?token=TOKEN
 *
 * Gera feed XML no formato Zap Imóveis (ListingDataFeed — mesmo grupo OLX/Viva Real).
 * Requer que xmlHabilitado=true e o token correto na query string.
 *
 * Spec: https://ajuda.zapimoveis.com.br/hc/pt-br (integração via XML)
 */
...
function gerarXmlZap(imobiliaria: ImobiliariaFeed, imoveis: ImovelFeed[], baseUrl: string): string {
...
export async function GET(request: NextRequest) {
  ...
  const xml = gerarXmlZap(acesso.imobiliaria, imoveis, baseUrl);
